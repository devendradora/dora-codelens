...
import { WebviewAnalysisData, ModuleGraphData, CallGraphData, TechStackData } from '../../core/webview-utils';
import { TabbedWebviewProvider } from '../../tabbed-webview-provider';

suite('TabbedWebviewProvider Test Suite', () => {
    let webviewProvider: TabbedWebviewProvider;
    ...
    setup(() => {
        ...
        webviewProvider = new TabbedWebviewProvider(mockContext, outputChannel);
    });
    ...
    test('should create TabbedWebviewProvider instance', () => {
        ...
        assert.ok(webviewProvider instanceof TabbedWebviewProvider);
    });
