...
export class ModalManager {
     ...
     */
    public showModal(config: ModalConfig, controls?: ModalControls): void {
        try {
     ...
     */
    private createModalElement(config: ModalConfig, controls?: ModalControls): HTMLElement {
     ...
     */
    private createModalHeader(config: ModalConfig, controls?: ModalControls): HTMLElement {
     ...
     */
    private createModalControls(modalId: string, controls: ModalControls): HTMLElement {
     ...
     */
    private setupModalEventListeners(modalId: string): void {
     ...
     */
    private cleanupModalEventListeners(modalId: string): void {
     ...
     */
    private handleSearch(modalId: string, query: string): void {
     ...
     */
    private handleZoom(modalId: string, delta: number): void {
     ...
     */
    private handleReset(modalId: string): void {
        // Reset zoom
     ...
     */
    private findTextMatches(element: HTMLElement, query: string): SearchResult[] {
     ...
     */
    private highlightSearchResults(element: HTMLElement, results: SearchResult[]): void {
     ...
     */
    private clearSearchHighlights(element: HTMLElement): void {
     ...
     */
    private manageFocus(modalElement: HTMLElement): void {
