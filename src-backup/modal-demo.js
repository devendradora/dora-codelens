...
class ModalDemo {
     ...
     */
    createCustomControlsModalContent() {
        const container = document.createElement('div');
        container.innerHTML = `
            <div style="padding: 20px;">
     ...
     */
    createCodeAnalysisModalContent() {
        const container = document.createElement('div');
        container.innerHTML = `
            <div style="padding: 20px;">
...
import { ZoomController } from './zoom-controller';</code></pre>
     ...
     */
    createDatabaseSchemaModalContent() {
        const container = document.createElement('div');
        container.innerHTML = `
            <div style="padding: 20px;">
