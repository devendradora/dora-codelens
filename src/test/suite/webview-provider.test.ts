...
import { WebviewProvider, WebviewAnalysisData, ModuleGraphData, CallGraphData, TechStackData } from '../../webview-provider';
...
suite('WebviewProvider Test Suite', () => {
    ...
    const mockAnalysisData: WebviewAnalysisData = {
        modules: {
            nodes: [
                {
                    id: 'main.py',
    ...
    setup(() => {
        ...
        webviewProvider = new WebviewProvider(mockContext, outputChannel);
    });
    ...
    test('should create WebviewProvider instance', () => {
        assert.ok(webviewProvider);
        assert.ok(webviewProvider instanceof WebviewProvider);
    });
    ...
    test('should handle empty analysis data', () => {
        const emptyData: WebviewAnalysisData = {};
    ...
    test('should handle analysis data with missing modules', () => {
        const dataWithoutModules: WebviewAnalysisData = {
    ...
    test('should handle analysis data with missing functions', () => {
        const dataWithoutFunctions: WebviewAnalysisData = {
