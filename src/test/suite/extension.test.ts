...
suite('Extension Integration Test Suite', () => {
    ...
    test('All commands should be registered', async () => {
        ...
        const expectedCommands = [
            'codemindmap.analyzeProject',
            'codemindmap.showModuleGraph',
            'codemindmap.showCallHierarchy',
            'codemindmap.refreshSidebar',
            'codemindmap.openSettings',
            'codemindmap.clearCache',
            'codemindmap.showOutput',
            'codemindmap.cancelAnalysis',
            'codemindmap.navigateToItem',
            'codemindmap.filterSidebar',
            'codemindmap.selectModule',
            'codemindmap.clearSelection',
            'codemindmap.showDependencies',
            'codemindmap.showFunctionComplexityDetails'
        ];
