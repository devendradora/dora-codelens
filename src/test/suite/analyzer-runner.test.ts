...
suite('AnalyzerRunner Test Suite', () => {
    let analyzerRunner: AnalyzerRunner;
    ...
    setup(() => {
        ...
        analyzerRunner = new AnalyzerRunner(outputChannel, mockExtensionPath);
    });
    ...
    test('should create AnalyzerRunner instance', () => {
        ...
        assert.ok(analyzerRunner instanceof AnalyzerRunner);
    });
    ...
    test('should handle progress reporting', async () => {
        ...
        try {
            ...
            const initialReport = progressReports.find(report => 
                report.message && report.message.includes('Preparing')
            );
    ...
    test('should handle missing analyzer script', async () => {
        ...
        const invalidAnalyzerRunner = new AnalyzerRunner(outputChannel, '/invalid/path');
